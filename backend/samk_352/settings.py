"""
Django settings for samk_352 project.
...
WSGI_APPLICATION = 'samk_352.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samk_352 API",
    "DESCRIPTION": "API documentation for samk_352 App",
    "VERSION": "v1",
}
